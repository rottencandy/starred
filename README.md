...
- [nooga/xsofy](https://github.com/nooga/xsofy) - Roguelike that names itself each run. WIP
...
- [conforma/cli](https://github.com/conforma/cli) - Conforma verifies that software supply chain policies are met.
